...
vim.api.nvim_set_keymap("n", "<Leader>e", ":SymbolsOutlineOpen<CR>:<cmd>UndotreeHide<CR>:NvimTreeToggle<CR>", {
	noremap = true,
	silent = true,
})
...
vim.api.nvim_set_keymap("v", "<Leader>vh", ":nohlsearch<CR>", {
	noremap = true,
	silent = true,
})
...
vim.api.nvim_set_keymap("x", "J", ":move '>+2<CR>gv-gv", {
	noremap = true,
	silent = true,
})
vim.api.nvim_set_keymap("n", "K", ":move .-2<CR>==", {
	noremap = true,
	silent = true,
})
vim.api.nvim_set_keymap("n", "J", ":move .+1<CR>==", {
	noremap = true,
	silent = true,
})
...
vim.api.nvim_set_keymap("i", "<c-k>", '("<C-p>")', {
	noremap = true,
	silent = true,
	expr = true,
})
...
vim.api.nvim_set_keymap("n", "<F1>", ":lua vim.lsp.buf.hover()<CR>", {
	noremap = true,
	silent = true,
})
...
vim.api.nvim_set_keymap("n", "<space><CR>", ":source ~/.config/nvim/init.lua<CR>", {
	noremap = true,
	silent = true,
})
...
vim.api.nvim_set_keymap("i", "<leader>vt", "<cmd>clap tags<cr>", {
	noremap = true,
	silent = true,
})
