...
-- vim.api.nvim_set_keymap("n", "<Leader>e", ":<cmd>UndotreeHide<CR>:<cmd>NvimTreeToggle<CR>", {
-- 	noremap = true,
-- 	silent = true,
-- })
--
...
M.nvimtree = {
  ...
  n = {
    ...
    ["<leader>e"] = {"<cmd>UndotreeHide<CR><cmd>NvimTreeToggle<CR>" },
    ["<leader>u"] = {"<cmd>NvimTreeClose<CR><cmd>UndotreeToggle<CR>"}
  },
}
