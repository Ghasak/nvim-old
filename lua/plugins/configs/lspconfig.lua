...
local function custom_attach(client, bufnr)
  ...
  buf_set_keymap("n", "<space>fn", "<cmd>lua vim.lsp.buf.formatting()<CR>",
    opts)
  -----------------------------------------------------------------------------------
  ...
  elseif client.resolved_capabilities.document_range_formatting then
    buf_set_keymap("n", "fn", "<cmd>lua vim.lsp.buf.range_formatting()<CR>",
      opts)
  end
...
-- ===========================================================================
--                   Julia Custom Language Server (CLS)
-- ===========================================================================
